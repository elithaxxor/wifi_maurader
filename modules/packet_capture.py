...
class PacketCapture:
    ...
    def save_to_pcap(self):
        ...
        command = [
            'tshark',
            '-i', self.interface,
            '-a', 'duration:60',  # default 1 minute for preview
            '-w', filename
        ]
...
# Next: Evil Twin Access Point Launcher + Captive Portal Deployment
# Modules will include hostapd, dnsmasq, iptables setup, and a simple Flask app for phishing portals.
